...
#define USB_Signal_End_Of_Data_Cunsumed	EP3R = (EP3R^0x3000)&0xBF8F


//USB endpoint glossary
//0x000F - endpoint address
//0x0030 - TX status bits
//0x0040 - Data Toggle, for transmission transfers
//0x0080 - Correct Transfer for transmission
//0x0100 - Endpoint Kind
//0x0600 - EP_TYPE[1:0] bits (Endpoint type)
//0x0800 - Setup transaction completed
//0x3000 - Status bits, for reception transfers
//0x4000 - Data Toggle, for reception transfers
//0x8000 - Correct Transfer for reception
