...
#define DS_USART_SET_BAUD			0x10	//принята команда назначить бодрейт
#define DS_USART_SET_INPUT			0x11	//принята команда включить/отключить приём данных
#define DS_ANS_SET_ABSOLUT_TIME		0x12	//принята команда установить время G8, значение передается через DS_param
#define DS_USART_SET_TIMEOUT		0x13	//принята команда назначить максимальное время на приём команды
//следующие два - строго один за другим
#define DS_ANS_U1T_DONE 			0x14	//данные на usart1 отправлены
#define DS_ANS_U2T_DONE 			0x15	//данные на usart2 отправлены

#define DS_USART_SET_WAIT			0x16	//принята команда включить/отключить ожидание отправки данных
