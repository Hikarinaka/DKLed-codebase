...
/**
  * @brief  enables and initalizes the NVIC peripheral according to the specified
  *         parameters.
  * @retval None
  */
void NVIC_Enable(uint8_t NVIC_IRQChannel,uint8_t NVIC_IRQChannelPreemptionPriority, uint8_t NVIC_IRQChannelSubPriority)
{
  uint32_t tmppriority = 0x00, tmppre = 0x00, tmpsub = 0x0F;
